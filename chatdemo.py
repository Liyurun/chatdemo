...
demo.title = "雁客的ChatGPT 🚀"   # 界面标题

if __name__ == "__main__":
    # 如果当前文件为__main__，则执行下面的代码
    reload_javascript()
    # 如果当前文件为__main__，则重新加载javascript
    ...
    if authflag:
        ...
        demo.queue(concurrency_count=CONCURRENT_COUNT).launch(server_name="0.0.0.0", server_port=7860,auth=auth_list, share=False) # 可自定义端口
