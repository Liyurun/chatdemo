...
CONCURRENT_COUNT = 1000 # 允许同时使用的用户数量

SIM_K = 5
INDEX_QUERY_TEMPRATURE = 1.0

CHUANHU_TITLE = """<h1 align="left">雁客的Chat空间</h1>"""
CHUANHU_DESCRIPTION = """\
<div align="center" style="margin:16px 0">

AIGC学习 [公众号(fire_aigc)](https://space.bilibili.com/29125536) 和 [AIGC的chat茶室](https://t.zsxq.com/0daLPgh0i)开发
...
# MODELS = ["gpt-3.5-turbo","gpt-3.5-turbo-0301","gpt-4","gpt-4-0314","gpt-4-32k","gpt-4-32k-0314","chatglm-6b","chatglm-6b-int4","chatglm-6b-int4-qe","llama-7b-hf","llama-7b-hf-int4","llama-7b-hf-int8","llama-13b-hf","llama-13b-hf-int4","llama-30b-hf","llama-30b-hf-int4","llama-65b-hf",]  # 可选的模型
